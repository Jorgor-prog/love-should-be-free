...
export default function LoginPage(){
  ...
  return (
    <div style={{
      ...
      <form onSubmit={submit} style={{width:360, background:'rgba(17,24,39,.85)', border:'1px solid #1f2937', borderRadius:12, padding:18, color:'#e5e7eb', backdropFilter:'blur(8px)'}}>
