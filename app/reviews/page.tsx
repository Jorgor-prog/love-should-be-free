...
export default function Reviews(){
  const items = [
    ...
    "Огурцы как огурцы: солёные, слегка кисловатые...    Огурцы как огурцы: солёные, слегка кисловатые...уцкцукукцку тест поменяем "
    "Огурцы как огурцы: солёные, слегка кисловатые...Огурцы как огурцы: солёные, слегка кисловатые...2323243 "
  ];
